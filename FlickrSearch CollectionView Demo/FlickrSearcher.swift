...
let apiKey = "44545d531e1563cac55b7d9ef330e4ae"
...
//      }
        ...
        let resultsDictionary = try!
            NSJSONSerialization.JSONObjectWithData(data!, options: NSJSONReadingOptions(rawValue: 0)) as? NSDictionary
